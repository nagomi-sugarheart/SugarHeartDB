# -*- coding: utf-8 -*-
"""CoCo夏夏夏 Holiday コミュ画像のCloudinaryアップロード

- merged_coco_commu.json で使用されているフレームのみアップロード
- ログ画像（Tr1/Tr2/OP/1〜5/ED）もアップロード（10MB超はJPEGに圧縮）
...
FRAMES_DIR = Path(r"C:\Users\sawas\Downloads\comm_frames\CoCo夏夏夏Holiday_202606250743")
LOG_DIR = Path(r"G:\マイドライブ\コミュ")
LOG_PREFIX = "CoCo夏夏夏 Holiday"
MERGED = REPO / "scripts" / "merged_coco_commu.json"
MAP_FILE = REPO / "_cloudinary_upload_map.json"
BASE = "Deresute/Event/CoCoNatsuHoliday"
