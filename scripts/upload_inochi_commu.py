# -*- coding: utf-8 -*-
"""命燃やして恋せよ乙女 コミュ画像のCloudinaryアップロード

- merged_inochi_commu.json で使用されているフレームのみアップロード
...
FRAMES_DIR = Path(r"C:\Users\sawas\Downloads\comm_frames\命燃やして恋せよ乙女_202606220001")
LOG_DIR = Path(r"G:\マイドライブ\コミュ")
LOG_PREFIX = "命燃やして恋せよ乙女"
MERGED = REPO / "scripts" / "merged_inochi_commu.json"
MAP_FILE = REPO / "_cloudinary_upload_map.json"
BASE = "Deresute/Event/InochiMoyashiteKoiseyoOtome"
