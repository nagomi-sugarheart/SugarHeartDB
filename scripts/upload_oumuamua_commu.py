# -*- coding: utf-8 -*-
"""オウムアムアに幸運を コミュ画像のCloudinaryアップロード

- merged_oumuamua_commu.json で使用されているフレームのみアップロード
- ログ画像10枚もアップロード（OP分岐のためOP/OP_Bの両方。10MB超はJPEGに圧縮）
...
FRAMES_DIR = Path(r"C:\Users\sawas\Downloads\comm_frames\オウムアムアに幸運を_202606212358")
LOG_DIR = Path(r"G:\マイドライブ\コミュ")
LOG_PREFIX = "オウムアムアに幸運を"
MERGED = REPO / "scripts" / "merged_oumuamua_commu.json"
MAP_FILE = REPO / "_cloudinary_upload_map.json"
BASE = "Deresute/Event/OumuamuaKooun"
LOG_CODES = ["Tr1", "Tr2", "OP", "OP_B", "1", "2", "3", "4", "5", "ED"]
