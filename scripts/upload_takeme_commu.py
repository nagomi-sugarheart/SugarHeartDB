# -*- coding: utf-8 -*-
"""Take me☆Take you コミュ画像のCloudinaryアップロード

- merged_takeme_commu.json で使用されているフレームのみアップロード
...
FRAMES_DIR = Path(r"C:\Users\sawas\Downloads\comm_frames\Take me☆Take you_202606222304")
LOG_DIR = Path(r"G:\マイドライブ\コミュ")
LOG_PREFIX = "Take me☆Take you"
MERGED = REPO / "scripts" / "merged_takeme_commu.json"
MAP_FILE = REPO / "_cloudinary_upload_map.json"
BASE = "Deresute/Event/TakeMeTakeYou"
