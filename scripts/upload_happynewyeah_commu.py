# -*- coding: utf-8 -*-
"""Happy New Yeah！ コミュ画像のCloudinaryアップロード

- merged_hny_commu.json で使用されているフレームのみアップロード
...
FRAMES_DIR = Path(r"C:\Users\sawas\Downloads\comm_frames\Happy New Yeah!_202606220252")
LOG_DIR = Path(r"G:\マイドライブ\コミュ")
LOG_PREFIX = "Happy New Yeah！"
MERGED = REPO / "scripts" / "merged_hny_commu.json"
MAP_FILE = REPO / "_cloudinary_upload_map.json"
BASE = "Deresute/Event/HappyNewYeah"
