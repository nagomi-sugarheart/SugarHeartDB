# -*- coding: utf-8 -*-
"""merged_netsujou_commu.json から 熱情エナモラル のイベントコミュHTMLを生成する

出力: scripts/netsujou_commu_section.html（ページに手動で組み込む用の断片）
"""
import html
import json
import sys
...
OUT = REPO / "scripts" / "netsujou_commu_section.html"

CDN = "https://res.cloudinary.com/dnmzdghoi/image/upload/f_auto,q_auto/Deresute/Event/NetsujouEnamorar"
PREFIX = "ne"
