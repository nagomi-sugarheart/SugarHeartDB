# -*- coding: utf-8 -*-
"""merged_commu.json から凸凹スピードスターのイベントコミュHTMLを生成する

出力: scripts/dekoboko_commu_section.html（ページに手動で組み込む用の断片）
"""
import html
import json
import sys
...
OUT = REPO / "scripts" / "dekoboko_commu_section.html"

CDN = "https://res.cloudinary.com/dnmzdghoi/image/upload/f_auto,q_auto/Deresute/Event/DekobokoSpeedStar"
