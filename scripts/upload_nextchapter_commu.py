# -*- coding: utf-8 -*-
"""Next Chapter コミュ画像のCloudinaryアップロード

- merged_nextchapter_commu.json で使用されているフレームのみアップロード
...
# CLOUDINARY_URL を ~/.claude.json から取得（未設定時）
...
FRAMES_DIR = Path(r"C:\Users\sawas\Downloads\comm_frames\Next Chapter_202606282127")
LOG_DIR = Path(r"G:\マイドライブ\コミュ")
LOG_PREFIX = "Next Chapter"
MERGED = REPO / "scripts" / "merged_nextchapter_commu.json"
MAP_FILE = REPO / "_cloudinary_upload_map.json"
BASE = "Deresute/Event/NextChapter"
