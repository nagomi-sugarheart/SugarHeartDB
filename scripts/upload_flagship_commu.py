# -*- coding: utf-8 -*-
"""躍るFLAGSHIP コミュ画像のCloudinaryアップロード

- merged_flagship_commu.json で使用されているフレームのみアップロード
...
FRAMES_DIR = Path(r"C:\Users\sawas\Downloads\comm_frames\躍るFLAGSHIP_202606222305")
LOG_DIR = Path(r"G:\マイドライブ\コミュ")
LOG_PREFIX = "躍るFLAGSHIP"
MERGED = REPO / "scripts" / "merged_flagship_commu.json"
MAP_FILE = REPO / "_cloudinary_upload_map.json"
BASE = "Deresute/Event/OdoruFlagship"
