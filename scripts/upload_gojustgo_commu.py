# -*- coding: utf-8 -*-
"""Go Just Go！ コミュ画像のCloudinaryアップロード

- merged_gojustgo_commu.json で使用されているフレームのみアップロード
...
FRAMES_DIR = Path(r"C:\Users\sawas\Downloads\comm_frames\Go Just Go!_202606222303")
LOG_DIR = Path(r"G:\マイドライブ\コミュ")
LOG_PREFIX = "Go Just Go"
MERGED = REPO / "scripts" / "merged_gojustgo_commu.json"
MAP_FILE = REPO / "_cloudinary_upload_map.json"
BASE = "Deresute/Event/GoJustGo"
LOG_CODES = ["Tr1", "Tr2", "OP_B", "1", "2", "3", "4", "5", "ED"]
